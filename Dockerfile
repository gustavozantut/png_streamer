...
#run
#docker build -t guhzantut/yolov5_live_gst:latest . ; docker run --ipc=host --gpus all -it -v toll_runs:/runs --rm -e RUN_NAME=20240120212331883337 guhzantut/yolov5_live_gst:toll